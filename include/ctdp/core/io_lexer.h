// core/io_lexer.h — Constexpr lexing primitives
// Part of the compile-time DP library (C++20)
//
// Low-level character-by-character parsing of integers, doubles,
// and whitespace from string_view.  Fully constexpr, no domain-specific
// dependencies.
//
// These utilities are shared across the library:
//   - Graph I/O parsers (ctdp::graph::io)
//   - Future: calibration I/O, configuration parsing
//
// All functions operate on (string_view, position) pairs and return
// updated positions, enabling zero-copy forward-only parsing.

#ifndef CTDP_CORE_IO_LEXER_H
#define CTDP_CORE_IO_LEXER_H
