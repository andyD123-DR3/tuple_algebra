...
TEST(DescribedSpace, BudgetViaElementPredicate) {
    ...
    constexpr auto mem_limit = [&mem](FixField field, std::size_t choice) -> bool {
...
TEST(DescribedSpace, SwapCostFunctions) {
    ...
    constexpr double tput[4][3] = {
        { 1.0, 2.0, 5.0 },
        { 1.0, 3.0, 2.0 },
        { 1.0, 4.0, 8.0 },
        { 1.0, 2.0, 3.0 },
    };
    constexpr auto throughput = [&tput](FixField f, std::size_t c) -> double {
